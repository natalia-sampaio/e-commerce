...
<template>
  <div
    class="bg-white mx-3 my-10 p-6 border-4 border-pink-600 shadow-customcard max-w-sm grid items-end"
  >
    <div>
    ...
    <div>
      ...
      <div class="flex justify-between">
        <div>
          ...
          <span
            class="bg-orange-main text-orange-pale rounded px-2 py-[0.1rem] mx-4"
            v-if="discount > 0"
            >{{ discount }}%</span
          >
        </div>
